...
if  auth_status is False:
    ...
    secciones_por_rol = {
        "admin": ["🏢 Oficina VIP", "📋 Registro Fénix/Eros", "📋 Registro Bet Argento","📋 Registro Spirita","📋 Registro Atenea","📋 Registro Padrino Latino/Tiger","📆 Agenda Fénix","📆 Agenda Eros","📆 Agenda BetArgento","📊 Análisis Temporal","🔝 Métricas de jugadores"],
